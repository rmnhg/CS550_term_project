...
result1 = subprocess.Popen('grep -R "file of" logs | sort', shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
stdout1, stderr1 = result1.communicate()

result2 = subprocess.Popen('grep -R "file of" docker_files/logs | sort', shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
